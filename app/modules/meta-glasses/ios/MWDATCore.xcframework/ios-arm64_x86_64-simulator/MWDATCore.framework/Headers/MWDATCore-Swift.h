...
- (BOOL)startRegistrationAndReturnError:(NSError * _Nullable * _Nullable)error;
- (void)handleUrl:(NSURL * _Nonnull)url completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
- (BOOL)startUnregistrationAndReturnError:(NSError * _Nullable * _Nullable)error;
